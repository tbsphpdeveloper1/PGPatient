...
CREATE TABLE `tbl_activity_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_act_activity_by` (`activity_by`),
  KEY `FK_act_activity_for` (`activity_for`),
  KEY `FK_act_created_by` (`created_by`),
  CONSTRAINT `FK_act_activity_by` FOREIGN KEY (`activity_by`) REFERENCES `tbl_user` (`user_id`),
  CONSTRAINT `FK_act_activity_for` FOREIGN KEY (`activity_for`) REFERENCES `tbl_user` (`user_id`),
  CONSTRAINT `FK_act_created_by` FOREIGN KEY (`created_by`) REFERENCES `tbl_user` (`user_id`)
...
DROP TABLE IF EXISTS `tbl_api_access`;
...
DROP TABLE IF EXISTS `tbl_api_limits`;
...
DROP TABLE IF EXISTS `tbl_api_params`;
...
DROP TABLE IF EXISTS `tbl_api_submenu`;
...
CREATE TABLE `tbl_appointment` (
  ...
  KEY `FK_apt_order_id` (`order_id`),
  KEY `FK_apt_user_id` (`user_id`),
  KEY `FK_apt_doctor_id` (`doctor_id`),
  KEY `FK_apt_created_by` (`created_by`),
  KEY `FK_apt_confirmed_by` (`confirmed_by`),
  KEY `FK_apt_completed_by` (`completed_by`),
  KEY `FK_apt_reschedule_by` (`reschedule_by`),
  KEY `FK_apt_cancel_by` (`cancel_by`),
  KEY `FK_apt_updated_by` (`updated_by`),
  KEY `FK_apt_clinic_id` (`clinic_id`),
  KEY `FK_apt_patient_id` (`patient_id`),
  CONSTRAINT `FK_apt_cancel_by` FOREIGN KEY (`cancel_by`) REFERENCES `tbl_user` (`user_id`),
  CONSTRAINT `FK_apt_clinic_id` FOREIGN KEY (`clinic_id`) REFERENCES `tbl_user_clinics` (`clinic_id`),
  CONSTRAINT `FK_apt_completed_by` FOREIGN KEY (`completed_by`) REFERENCES `tbl_user` (`user_id`),
  CONSTRAINT `FK_apt_confirmed_by` FOREIGN KEY (`confirmed_by`) REFERENCES `tbl_user` (`user_id`),
  CONSTRAINT `FK_apt_created_by` FOREIGN KEY (`created_by`) REFERENCES `tbl_user` (`user_id`),
  CONSTRAINT `FK_apt_doctor_id` FOREIGN KEY (`doctor_id`) REFERENCES `tbl_user` (`user_id`),
  CONSTRAINT `FK_apt_order_id` FOREIGN KEY (`order_id`) REFERENCES `tbl_order` (`order_id`),
  CONSTRAINT `FK_apt_patient_id` FOREIGN KEY (`patient_id`) REFERENCES `tbl_user_patient` (`patient_id`),
  CONSTRAINT `FK_apt_reschedule_by` FOREIGN KEY (`reschedule_by`) REFERENCES `tbl_user` (`user_id`),
  CONSTRAINT `FK_apt_updated_by` FOREIGN KEY (`updated_by`) REFERENCES `tbl_user` (`user_id`),
  CONSTRAINT `FK_apt_user_id` FOREIGN KEY (`user_id`) REFERENCES `tbl_user` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `tbl_appointment_attachments`;
CREATE TABLE `tbl_appointment_attachments` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_aat_appointment_id` (`appointment_id`),
  CONSTRAINT `FK_aat_appointment_id` FOREIGN KEY (`appointment_id`) REFERENCES `tbl_appointment` (`appointment_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;


DROP TABLE IF EXISTS `tbl_appointment_feedback`;
CREATE TABLE `tbl_appointment_feedback` (
  ...
  KEY `FK_af_appointment_id` (`appointment_id`),
  CONSTRAINT `FK_af_appointment_id` FOREIGN KEY (`appointment_id`) REFERENCES `tbl_appointment` (`appointment_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;


DROP TABLE IF EXISTS `tbl_appointment_followup`;
CREATE TABLE `tbl_appointment_followup` (
  ...
  KEY `FK_afl_appointment_id` (`appointment_id`),
  CONSTRAINT `FK_afl_appointment_id` FOREIGN KEY (`appointment_id`) REFERENCES `tbl_appointment` (`appointment_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;


DROP TABLE IF EXISTS `tbl_appointment_prescriptions`;
CREATE TABLE `tbl_appointment_prescriptions` (
  ...
  KEY `FK_apr_appointment_id` (`appointment_id`),
  CONSTRAINT `FK_apr_appointment_id` FOREIGN KEY (`appointment_id`) REFERENCES `tbl_appointment` (`appointment_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;


DROP TABLE IF EXISTS `tbl_appointment_reports`;
CREATE TABLE `tbl_appointment_reports` (
  ...
  KEY `FK_arp_appointment_id` (`appointment_id`),
  CONSTRAINT `FK_arp_appointment_id` FOREIGN KEY (`appointment_id`) REFERENCES `tbl_appointment` (`appointment_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tbl_appointment_services` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_asr_appointment_id` (`appointment_id`),
  CONSTRAINT `FK_asr_appointment_id` FOREIGN KEY (`appointment_id`) REFERENCES `tbl_appointment` (`appointment_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `tbl_appointment_status_history`;
CREATE TABLE `tbl_appointment_status_history` (
  ...
  `created_date` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `FK_ash_created_by` (`created_by`),
  KEY `FK_ash_appointment_id` (`appointment_id`),
  CONSTRAINT `FK_ash_appointment_id` FOREIGN KEY (`appointment_id`) REFERENCES `tbl_appointment` (`appointment_id`),
  CONSTRAINT `FK_ash_created_by` FOREIGN KEY (`created_by`) REFERENCES `tbl_user` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tbl_article` (
  ...
  KEY `FK_art_created_by` (`created_by`),
  KEY `FK_art_updated_by` (`updated_by`),
  KEY `FK_art_category_id` (`category_id`),
  CONSTRAINT `FK_art_category_id` FOREIGN KEY (`category_id`) REFERENCES `tbl_article_category` (`category_id`),
  CONSTRAINT `FK_art_created_by` FOREIGN KEY (`created_by`) REFERENCES `tbl_user` (`user_id`),
  CONSTRAINT `FK_art_updated_by` FOREIGN KEY (`updated_by`) REFERENCES `tbl_user` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tbl_article_category` (
  ...
  KEY `FK_art_cat_created_by` (`created_by`),
  KEY `FK_art_cat_updated_by` (`updated_by`),
  CONSTRAINT `FK_art_cat_created_by` FOREIGN KEY (`created_by`) REFERENCES `tbl_user` (`user_id`),
  CONSTRAINT `FK_art_cat_updated_by` FOREIGN KEY (`updated_by`) REFERENCES `tbl_user` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `tbl_article_category_follow`;
...
DROP TABLE IF EXISTS `tbl_article_likes`;
...
DROP TABLE IF EXISTS `tbl_clinic_amenities`;
CREATE TABLE `tbl_clinic_amenities` (
  ...
  KEY `FK_clm_created_by` (`created_by`),
  KEY `FK_clm_updated_by` (`updated_by`),
  CONSTRAINT `FK_clm_created_by` FOREIGN KEY (`created_by`) REFERENCES `tbl_user` (`user_id`),
  CONSTRAINT `FK_clm_updated_by` FOREIGN KEY (`updated_by`) REFERENCES `tbl_user` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;


DROP TABLE IF EXISTS `tbl_cms_content`;
CREATE TABLE `tbl_cms_content` (
  ...
  KEY `FK_cmcc_created_by` (`created_by`),
  KEY `FK_cmcc_updated_by` (`updated_by`),
  CONSTRAINT `FK_cmcc_created_by` FOREIGN KEY (`created_by`) REFERENCES `tbl_user` (`user_id`),
  CONSTRAINT `FK_cmcc_updated_by` FOREIGN KEY (`updated_by`) REFERENCES `tbl_user` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `tbl_cms_menus`;
CREATE TABLE `tbl_cms_menus` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_cmcm_created_by` (`created_by`),
  KEY `FK_cmcm_updated_by` (`updated_by`),
  CONSTRAINT `FK_cmcm_created_by` FOREIGN KEY (`created_by`) REFERENCES `tbl_user` (`user_id`),
  CONSTRAINT `FK_cmcm_updated_by` FOREIGN KEY (`updated_by`) REFERENCES `tbl_user` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `tbl_cms_sliders`;
...
DROP TABLE IF EXISTS `tbl_cms_speciality`;
...
DROP TABLE IF EXISTS `tbl_country_regions`;
CREATE TABLE `tbl_country_regions` (
  ...
  UNIQUE KEY `cr_unique` (`country_code`,`region_code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `tbl_country_region_cities`;
CREATE TABLE `tbl_country_region_cities` (
  ...
  `updated_date` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`city_id`),
  UNIQUE KEY `crc_unique` (`country_code`,`region_code`,`city_name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tbl_currency` (
  ...
  KEY `FK_c_created_by` (`created_by`),
  KEY `FK_d_updated_by` (`updated_by`),
  CONSTRAINT `FK_c_created_by` FOREIGN KEY (`created_by`) REFERENCES `tbl_user` (`user_id`),
  CONSTRAINT `FK_c_updated_by` FOREIGN KEY (`updated_by`) REFERENCES `tbl_user` (`user_id`),
  CONSTRAINT `FK_d_updated_by` FOREIGN KEY (`updated_by`) REFERENCES `tbl_user` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `tbl_db_tables`;
...
CREATE TABLE `tbl_diseases` (
  ...
  KEY `FK_d_created_by` (`created_by`),
  CONSTRAINT `FK_d_created_by` FOREIGN KEY (`created_by`) REFERENCES `tbl_user` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tbl_email_templates` (
  ...
  KEY `FK_et_created_by` (`created_by`),
  KEY `FK_et_updated_by` (`updated_by`),
  CONSTRAINT `FK_et_created_by` FOREIGN KEY (`created_by`) REFERENCES `tbl_user` (`user_id`),
  CONSTRAINT `FK_et_updated_by` FOREIGN KEY (`updated_by`) REFERENCES `tbl_user` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tbl_enquiry` (
  ...
  KEY `FK_enq_user_id` (`user_id`),
  CONSTRAINT `FK_enq_user_id` FOREIGN KEY (`user_id`) REFERENCES `tbl_user` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;


DROP TABLE IF EXISTS `tbl_enquiry_reply`;
CREATE TABLE `tbl_enquiry_reply` (
  ...
  `created_date` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `FK_enq_r_user_id` (`user_id`),
  CONSTRAINT `FK_enq_r_user_id` FOREIGN KEY (`user_id`) REFERENCES `tbl_user` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `tbl_insurance_providers`;
CREATE TABLE `tbl_insurance_providers` (
  ...
  KEY `FK_ip_created_by` (`created_by`),
  KEY `FK_ip_updated_by` (`updated_by`),
  CONSTRAINT `FK_ip_created_by` FOREIGN KEY (`created_by`) REFERENCES `tbl_user` (`user_id`),
  CONSTRAINT `FK_ip_updated_by` FOREIGN KEY (`updated_by`) REFERENCES `tbl_user` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tbl_languages` (
  ...
  KEY `FK_lang_created_by` (`created_by`),
  KEY `FK_lang_updated_by` (`updated_by`),
  CONSTRAINT `FK_lang_created_by` FOREIGN KEY (`created_by`) REFERENCES `tbl_user` (`user_id`),
  CONSTRAINT `FK_lang_updated_by` FOREIGN KEY (`updated_by`) REFERENCES `tbl_user` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `tbl_language_contents`;
CREATE TABLE `tbl_language_contents` (
  ...
  `updated_date` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `content_type` (`content_type`,`row_id`,`lang_code`) USING BTREE,
  KEY `FK_lc_created_by` (`created_by`),
  KEY `FK_lc_updated_by` (`updated_by`),
  CONSTRAINT `FK_lc_created_by` FOREIGN KEY (`created_by`) REFERENCES `tbl_user` (`user_id`),
  CONSTRAINT `FK_lc_updated_by` FOREIGN KEY (`updated_by`) REFERENCES `tbl_user` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tbl_order` (
  ...
  KEY `FK_ord_user_id` (`user_id`),
  CONSTRAINT `FK_ord_user_id` FOREIGN KEY (`user_id`) REFERENCES `tbl_user` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tbl_order_address` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_oa_order_id` (`order_id`),
  CONSTRAINT `FK_oa_order_id` FOREIGN KEY (`order_id`) REFERENCES `tbl_order` (`order_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tbl_order_items` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_oia_order_id` (`order_id`),
  CONSTRAINT `FK_oia_order_id` FOREIGN KEY (`order_id`) REFERENCES `tbl_order` (`order_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `tbl_order_payment_history`;
CREATE TABLE `tbl_order_payment_history` (
  ...
  KEY `FK_oph_order_id` (`order_id`),
  CONSTRAINT `FK_oph_order_id` FOREIGN KEY (`order_id`) REFERENCES `tbl_order` (`order_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tbl_order_status_history` (
  ...
  KEY `FK_osh_order_id` (`order_id`),
  CONSTRAINT `FK_osh_order_id` FOREIGN KEY (`order_id`) REFERENCES `tbl_order` (`order_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `tbl_order_total`;
CREATE TABLE `tbl_order_total` (
  ...
  CONSTRAINT `FK_ot_order_id` FOREIGN KEY (`order_id`) REFERENCES `tbl_order` (`order_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tbl_settings` (
  ...
  KEY `FK_set_created_by` (`created_by`),
  KEY `FK_set_updated_by` (`updated_by`),
  CONSTRAINT `FK_set_created_by` FOREIGN KEY (`created_by`) REFERENCES `tbl_user` (`user_id`),
  CONSTRAINT `FK_set_updated_by` FOREIGN KEY (`updated_by`) REFERENCES `tbl_user` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tbl_specialization` (
  ...
  UNIQUE KEY `specialization_alias` (`specialization_alias`),
  KEY `FK_spz_created_by` (`created_by`),
  KEY `FK_spz_updated_by` (`updated_by`),
  CONSTRAINT `FK_spz_created_by` FOREIGN KEY (`created_by`) REFERENCES `tbl_user` (`user_id`),
  CONSTRAINT `FK_spz_updated_by` FOREIGN KEY (`updated_by`) REFERENCES `tbl_user` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `tbl_symptom_diseases`;
...
CREATE TABLE `tbl_universities` (
  ...
  `updated_date` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `FK_uni_created_by` (`created_by`),
  KEY `FK_uni_updated_by` (`updated_by`),
  CONSTRAINT `FK_uni_created_by` FOREIGN KEY (`created_by`) REFERENCES `tbl_user` (`user_id`),
  CONSTRAINT `FK_uni_updated_by` FOREIGN KEY (`updated_by`) REFERENCES `tbl_user` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tbl_user` (
  ...
  KEY `FK_us_created_by` (`created_by`),
  KEY `FK_us_updated_by` (`updated_by`),
  CONSTRAINT `FK_group_id` FOREIGN KEY (`group_id`) REFERENCES `tbl_user_group` (`group_id`),
  CONSTRAINT `FK_us_created_by` FOREIGN KEY (`created_by`) REFERENCES `tbl_user` (`user_id`),
  CONSTRAINT `FK_us_updated_by` FOREIGN KEY (`updated_by`) REFERENCES `tbl_user` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tbl_user_address` (
  ...
  KEY `FK_ua_user_id` (`user_id`) USING BTREE,
  CONSTRAINT `FK_ua_group_id` FOREIGN KEY (`user_id`) REFERENCES `tbl_user` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;


DROP TABLE IF EXISTS `tbl_user_assigned`;
CREATE TABLE `tbl_user_assigned` (
  ...
  KEY `FK_uas_user_id` (`user_id`) USING BTREE,
  KEY `FK_uas_assigned_to` (`assigned_to`) USING BTREE,
  KEY `FK_uas_assign_by` (`assign_by`) USING BTREE,
  CONSTRAINT `FK_uas_ab_user_id` FOREIGN KEY (`assign_by`) REFERENCES `tbl_user` (`user_id`),
  CONSTRAINT `FK_uas_at_user_id` FOREIGN KEY (`assigned_to`) REFERENCES `tbl_user` (`user_id`),
  CONSTRAINT `FK_uas_user_id` FOREIGN KEY (`user_id`) REFERENCES `tbl_user` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;


DROP TABLE IF EXISTS `tbl_user_authentication`;
...
(3,	4,	'73544b69585478427561464c6c4b32323224365a2464307531754a4e676b4f4a6672684676546b47452444586f743730777a6656797063616d4d2f39',	'2025-06-20 19:56:57',	'2020-11-06 15:23:09'),
(4,	5,	'56426a32593864246d32324b79467a76654f657553243164436235316b54494549527368306d76716f424c44623563706d244c384448423364667133',	'2025-04-04 16:57:28',	'2020-11-06 16:02:33'),
...
DROP TABLE IF EXISTS `tbl_user_awards`;
CREATE TABLE `tbl_user_awards` (
  ...
  `updated_date` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `ua_unique` (`user_id`,`name`),
  KEY `FK_uaw_user_id` (`user_id`),
  CONSTRAINT `FK_uaw_user_id` FOREIGN KEY (`user_id`) REFERENCES `tbl_user` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `tbl_user_banks`;
CREATE TABLE `tbl_user_banks` (
  ...
  `updated_date` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`bank_id`),
  KEY `FK_ub_user_id` (`user_id`),
  CONSTRAINT `FK_ub_user_id` FOREIGN KEY (`user_id`) REFERENCES `tbl_user` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `tbl_user_cards`;
CREATE TABLE `tbl_user_cards` (
  ...
  CONSTRAINT `FK_uc_user_id` FOREIGN KEY (`user_id`) REFERENCES `tbl_user` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;


DROP TABLE IF EXISTS `tbl_user_clinics`;
CREATE TABLE `tbl_user_clinics` (
  ...
  KEY `FK_ucl_user_id` (`user_id`),
  CONSTRAINT `FK_ucl_user_id` FOREIGN KEY (`user_id`) REFERENCES `tbl_user` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `tbl_user_clinics_attachments`;
CREATE TABLE `tbl_user_clinics_attachments` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_uca_clinic_id` (`clinic_id`),
  CONSTRAINT `FK_uca_clinic_id` FOREIGN KEY (`clinic_id`) REFERENCES `tbl_user_clinics` (`clinic_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;


DROP TABLE IF EXISTS `tbl_user_clinics_relation`;
CREATE TABLE `tbl_user_clinics_relation` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` bigint(20) NOT NULL,
  `clinic_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_ucr_user_id` (`user_id`),
  KEY `FK_ucr_clinic_id` (`clinic_id`),
  CONSTRAINT `FK_ucr_clinic_id` FOREIGN KEY (`clinic_id`) REFERENCES `tbl_user_clinics` (`clinic_id`),
  CONSTRAINT `FK_ucr_user_id` FOREIGN KEY (`user_id`) REFERENCES `tbl_user` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `tbl_user_devices`;
CREATE TABLE `tbl_user_devices` (
  ...
  CONSTRAINT `FK_ud_user_id` FOREIGN KEY (`user_id`) REFERENCES `tbl_user` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `tbl_user_documents`;
CREATE TABLE `tbl_user_documents` (
  ...
  KEY `FK_udoc_user_id` (`user_id`),
  CONSTRAINT `FK_udoc_user_id` FOREIGN KEY (`user_id`) REFERENCES `tbl_user` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tbl_user_education` (
  ...
  `updated_date` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `FK_uedu_user_id` (`user_id`) USING BTREE,
  CONSTRAINT `FK_ue_user_id` FOREIGN KEY (`user_id`) REFERENCES `tbl_user` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tbl_user_experience` (
  ...
  `updated_date` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `FK_uexp_user_id` (`user_id`),
  CONSTRAINT `FK_uexp_user_id` FOREIGN KEY (`user_id`) REFERENCES `tbl_user` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `tbl_user_insurance`;
CREATE TABLE `tbl_user_insurance` (
  ...
  `website` varchar(100) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_uins_user_id` (`user_id`),
  KEY `FK_uins_provider_id` (`provider_id`) USING BTREE,
  CONSTRAINT `FK_ui_provider_id` FOREIGN KEY (`provider_id`) REFERENCES `tbl_insurance_providers` (`provider_id`),
  CONSTRAINT `FK_uins_user_id` FOREIGN KEY (`user_id`) REFERENCES `tbl_user` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;


DROP TABLE IF EXISTS `tbl_user_patient`;
CREATE TABLE `tbl_user_patient` (
  ...
  KEY `FK_upat_user_id` (`user_id`),
  CONSTRAINT `FK_upat_user_id` FOREIGN KEY (`user_id`) REFERENCES `tbl_user` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(2,	5,	'Self',	'Patient One',	'patient1@mailinator.com',	'',	NULL,	'0000-00-00',	'6856547456',	'',	'',	'',	'',	'',	'2020-11-02 10:54:21',	'2020-11-02 10:54:21'),
...
(5,	5,	'Family',	'Sonu Kumar',	'ap@mailinator.com',	'caf9a9599c593359b1ec0ab2233f6c9a-user-patients-5.jpg',	'Male',	'1990-01-31',	'6585455256',	'A+',	'Lorem ipsum allergies',	'Loem ipsum medical histories',	'156',	'58',	'2020-11-06 13:21:40',	'2020-11-06 07:51:40'),
...
CREATE TABLE `tbl_user_services` (
  ...
  KEY `FK_usv_user_id` (`user_id`),
  KEY `FK_usv_clinic_id` (`clinic_id`),
  CONSTRAINT `FK_usv_clinic_id` FOREIGN KEY (`clinic_id`) REFERENCES `tbl_user_clinics` (`clinic_id`),
  CONSTRAINT `FK_usv_user_id` FOREIGN KEY (`user_id`) REFERENCES `tbl_user` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tbl_user_settings` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `us_unique` (`user_id`,`meta_key`,`meta_value`),
  KEY `FK_ust_user_id` (`user_id`),
  CONSTRAINT `FK_ust_user_id` FOREIGN KEY (`user_id`) REFERENCES `tbl_user` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `tbl_user_specialization`;
CREATE TABLE `tbl_user_specialization` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `usp_unique` (`user_id`,`specialization_id`,`sub_specialization_id`),
  KEY `FK_us_specialization_id` (`specialization_id`),
  KEY `FK_us_sub_specialization_id` (`sub_specialization_id`),
  CONSTRAINT `FK_us_specialization_id` FOREIGN KEY (`specialization_id`) REFERENCES `tbl_specialization` (`specialization_id`),
  CONSTRAINT `FK_us_sub_specialization_id` FOREIGN KEY (`sub_specialization_id`) REFERENCES `tbl_specialization` (`specialization_id`),
  CONSTRAINT `FK_usp_user_id` FOREIGN KEY (`user_id`) REFERENCES `tbl_user` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tbl_user_wallet` (
  ...
  KEY `FK_uwal_user_id` (`user_id`),
  KEY `FK_uwal_order_id` (`order_id`),
  CONSTRAINT `FK_uwal_order_id` FOREIGN KEY (`order_id`) REFERENCES `tbl_order` (`order_id`),
  CONSTRAINT `FK_uwal_user_id` FOREIGN KEY (`user_id`) REFERENCES `tbl_user` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tbl_user_work_schedule` (
  ...
  KEY `FK_usch_user_id` (`user_id`),
  KEY `FK_usch_clinic_id` (`clinic_id`),
  CONSTRAINT `FK_usch_clinic_id` FOREIGN KEY (`clinic_id`) REFERENCES `tbl_user_clinics` (`clinic_id`),
  CONSTRAINT `FK_usch_user_id` FOREIGN KEY (`user_id`) REFERENCES `tbl_user` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
